...
// Pasar esto si la ventana no está definida todavía
...
// intenta localizar las cadenas de llamadas "use strict". (# 13335)
// "use strict";
var deletedIds = [];
...
var
	...
	jQuery = function (selector, context) {
		...
		// Necesita init si se llama a jQuery (solo permite que el error sea lanzado si no está incluido)
		return new jQuery.fn.init (selector, context);
	},

	// Soporte: Android <4.1, IE <9
	// Asegúrate de que podamos recortar BOM y NBSP
	rtrim = / ^ [\ s \ uFEFF \ xA0] + | [\ s \ uFEFF \ xA0] + $ / g,

	// Combina la cadena de trazos para camelizing
	rmsPrefix = / ^ - ms- /,
	rdashAlpha = / - ([\ da-z]) / gi,
...
jQuery.fn = jQuery.prototype = {
	...
	// Obtener el elemento Nth en el conjunto de elementos coincidentes OR
	// Obtener el conjunto completo de elementos como un arreglo limpio
	get: function (num) {
		return num! = null?
...
jQuery.extend = jQuery.fn.extend = function () {
	var src, copyIsArray, copia, nombre, opciones, clon,
		target = arguments [0] || {},
		i = 1,
	...
	para (i <longitud; i ++) {
		...
		// Sólo se ocupan de valores no nulos / no definidos
		if ((options = arguments [i])! = null) {
			...
			para (nombre en opciones) {
				...
				// Recurrir si estamos fusionando objetos o matrices simples
				if (deep && copy && (jQuery.isPlainObject (copy) ||
					...
					target [nombre] = jQuery.extend (profundidad, clonación, copia);
...
jQuery.extend ({
	...
	isNumeric: function (obj) {
		...
		// ... pero interpreta mal las cadenas de números principales, en particular los literales hexadecimales ("0x ...")
	...
	isPlainObject: function (obj) {
		...
		tratar {
			...
			// Propiedades del constructor no propias deben ser Objeto
			if (obj.constructor &&
	...
	// Soluciones alternativas basadas en hallazgos de Jim Driscoll
	...
	// Convierte laschadas a camelCase; utilizado por los css y módulos de datos
	// Microsoft se olvidó de joroba su prefijo de proveedor (# 9572)
	camelCase: function (cadena) {
	...
	merge: function (first, second) {
		...
		// Soporte: IE <9
		// Colocación de casilla de resultados de .length a NaN en objetos de otro tipo arrays (por ejemplo, NodeLists)
		if (len! == len) {
	...
	grep: función (elems, callback, invertido) {
		var callbackInverse,
			partidos = [],
			i = 0,
	...
	mapa: function (elems, callback, arg) {
		...
		// Recorre la matriz, traduciendo cada uno de los elementos a sus nuevos valores
		...
		// Pasa por cada clave del objeto,
		} else {
			para (i en elems) {
				valor = devolución de llamada (elems [i], i, arg);
	...
	proxy: function (fn, context) {
		...
		// Establece el guid del manejador único al mismo del manejador original, por lo que se puede quitar
